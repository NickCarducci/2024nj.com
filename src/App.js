        ...
        <div>
          ...
          <div>
            ...
            {this.state.openEconomicGrowth && (
              ...
              >
                Economic growth is good if it's from{space}
                <b>greater access to new products</b>, but even income and
                employment otherwise is either from quantitative easing,
                investment, or worse: shrinkflation.
                <br />
                <br />
                Productivity is good when it’s from greater access to new
                products rather than quantitative easing, more investment,
                shrinkflation, or more hours worked.
                <br />
                <br />
                Economic growth of more hiring or income is exclusively
                generated by either inflationary quantitative easing (bad), the
                rich investing more than usual (a tradeoff of cash for shares,
                leisure, or material; potentially wasteful), greater access for
                new products (supporting the{space}
                <b>dynamic demand of savers</b>; good), or shrinkflation (bad).
                <br />
              </p>
            )}
            I’ll fight to:
