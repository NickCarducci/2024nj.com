import { XPCUtil } from "./XPCUtil";

export default function XPConnect(prim) {
  var file,
  ...
  file = {
    ...
    copyFile: function (
      ...
      if (onlyCopyNew) {
        if (
          destFile.exists() &&
          destFile.lastModifiedTime >= srcFile.lastModifiedTime
        ) {
