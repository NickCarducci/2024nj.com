...
export default function Help(dependency = arguments[0], BUILD = arguments[1]) {
  const { urlFchd, load } = dependency,
    depMap = (dm) => {
      return {
        dm,
        m:
      ...
      return m
        ...
        : KeyValue(
            ...
            Module.bind({
              ...
              getModule: Help.call(Dependency, dependency, BUILD).getModule,
              //depMap,
