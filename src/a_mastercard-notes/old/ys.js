    ...
    var mainScript,
      ...
      define = (
        ...
        seratimNull(
          variables,
          "undefined",
          (context = useInteractive ? contexts[n()[ga](WINDOW.dr())] : context)
        ) &&
        ...
        (!context ? defineables.push([nm, ds, c]) : true) &&
        context.defQueue.push([nm, ds, c]) &&
        (context.defQueueMap[nm] = true) && { amd: { jQuery: true } },
      contexts = {},
      us = "_",
      createElement = (ns) =>
      ...
      context = context ? context : (contexts[NAME] = new BUILD.start.newRequireable(NAME)); //dependency
      cfg && context.configure(cfg);
      return context.require(ds, cb, eb);
    */
      _f = "*",
      _p = "packages",
      _b = "bundles",
      ...
      BUILD = (variables.REQUIREJS = function () {
        ...
        context = e_(contexts).yes(NAME) && contexts[NAME];
        context = context
          ? context
          : (contexts[NAME] = new BUILD.start.newRequireable(NAME)); //dependency
        cfg && context.configure(cfg);
        return context.require(ds, cb, eb);
      }),
      e_ = (obj /*,string*/) => {
              ...
              return (
                ...
                seratimNull(
                  ...
                  ctxReqProps.forEach(
                    (prop) =>
                      (BUILD[prop] = function () {
                        return contexts[us].require[prop].apply(
                          contexts[us],
                          arguments
                        );
                      })
